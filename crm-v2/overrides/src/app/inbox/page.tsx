...
export default function InboxPage() {
  ...
  useEffect(() => {
    ...
    requestAnimationFrame(() => conversationEndRef.current?.scrollIntoView({ block: "end" }));
  }, [detail?.threadId, detail?.messages.length, detailLoading]);
