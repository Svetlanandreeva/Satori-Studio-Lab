...
const ROUTE_SEO: Record<string, RouteSeo> = {
  ...
  "/na-zakaz": {
    title: "Светильники и люстры на заказ — от лампы до инсталляции | SATORI",
    description: "SATORI создаёт свет на заказ: люстры, бра, торшеры, светильники для ресторанов и отелей, световые арт-объекты и инсталляции. По эскизу, референсу или с нуля, с доставкой по России.",
  },
  "/business": {
